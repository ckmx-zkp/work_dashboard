...
<div class="workstreams">
  <article class="stream"><div class="stream-top"><h3>业务后端</h3><span class="state amber">待 LLM 配置</span></div><p>设备、人设、历史、记忆/MCP、KB 与成长 worker 均已上线。</p><small>下一步：配置 LLM，验收真实摘要、候选记忆与成长建议。</small></article>
  <article class="stream"><div class="stream-top"><h3>用户端</h3><span class="state amber">内测推进中</span></div><p>登录、设备切换、人设、历史与外设状态已部署。</p><small>下一步：记忆、分析、日运体验；正式发布需 HTTPS。</small></article>
  <article class="stream"><div class="stream-top"><h3>运营管理台</h3><span class="state green">运营入口已上线</span></div><p>资产、人设、历史、外设、分析、KB 与记忆审核均可用。</p><small>下一步：基于真实 worker 数据验收运营流程。</small></article>
  <article class="stream"><div class="stream-top"><h3>设备与语音</h3><span class="state amber">待真机验收</span></div><p>人设刷新、外设回传与休息行为优化均已部署。</p><small>下一步：取得消息、外设与休息行为的端到端证据。</small></article>
</div>
<div class="two-column"><section class="panel"><h3>本周关键进展</h3><ol class="timeline"><li><time>2026-08-02</time>后端上线记忆/MCP、KB 与可配置的每日成长 worker。</li><li><time>2026-08-02</time>管理台上线 KB 运营和候选记忆审核。</li><li><time>2026-08-02</time>用户端上线对话历史与外设状态展示。</li><li><time>2026-08-02</time>小智服务上线休息断开、30 秒无语音断连与 24 kHz 下行优化。</li></ol></section><section class="panel"><h3>下一步（按优先级）</h3><ol class="priority"><li>用真实设备验收人设、消息、会话结束、眼睛状态和休息行为。</li><li>配置 worker 的 LLM 连接，验收摘要、记忆候选与成长建议。</li><li>将记忆、分析与日运能力接入用户端，完成运营闭环体验。</li></ol></section></div>
<div class="two-column"><section class="panel"><h3>当前风险与待决</h3><ul class="risk"><li><strong>主链路尚待验收</strong>代码已部署，但尚缺真实设备的消息、会话、外设和休息行为证据。</li><li><strong>运营数据待生成</strong>worker 已具备处理能力，尚需配置 LLM 后才会产生真实摘要、候选记忆与分析数据。</li><li><strong>正式发布条件不足</strong>用户端当前为 HTTP 内测入口，域名、HTTPS 与备案尚未完成。</li></ul></section><section class="panel"><h3>项目管理建议</h3><ul class="risk"><li><strong>以端到端证据验收</strong>以“激活 → 绑定 → 人设变更生效 → 语音对话 → 历史可见”作为下一阶段验收口径。</li><li><strong>先配置运营数据源</strong>LLM 配置后立即安排 worker 的摘要、候选记忆和审核流程验收。</li><li><strong>区分内测与发布</strong>对外发布前单独完成域名、HTTPS、安全与回归验证。</li></ul></section></div>
