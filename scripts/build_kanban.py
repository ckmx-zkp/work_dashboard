...
<div class="workstreams">
  <article class="stream"><div class="stream-top"><h3>业务后端</h3><span class="state green">基础能力已上线</span></div><p>账号、设备绑定码、人设与对话历史能力可用。</p><small>下一步：打通语音数据回传，补齐记忆与运营能力。</small></article>
  <article class="stream"><div class="stream-top"><h3>用户端</h3><span class="state amber">内测推进中</span></div><p>注册登录与设备绑定码认领已部署。</p><small>下一步：设备列表、人设和历史体验；正式发布需 HTTPS。</small></article>
  <article class="stream"><div class="stream-top"><h3>运营管理台</h3><span class="state amber">能力建设中</span></div><p>账号体系、当前账号设备查看和基础设备操作已上线。</p><small>风险：尚无独立的管理端资产/诊断接口。</small></article>
  <article class="stream"><div class="stream-top"><h3>设备与语音</h3><span class="state amber">联调推进中</span></div><p>真机激活、首轮语音对话、单眼情绪联动已验证。</p><small>下一步：修复业务数据回传兼容，完成设备登记和人设下发。</small></article>
</div>
<div class="two-column"><section class="panel"><h3>本周关键进展</h3><ol class="timeline"><li><time>2026-08-02</time>后端上线设备绑定码、人设和对话历史能力。</li><li><time>2026-08-02</time>用户端改用绑定码认领设备，并完成内测部署。</li><li><time>2026-08-02</time>管理台移除会占用用户设备归属的错误入口。</li><li><time>已验证</time>真机语音首轮对话与单眼情绪联动可用。</li></ol></section><section class="panel"><h3>下一步（按优先级）</h3><ol class="priority"><li>修复语音服务与后端的会话标识兼容，确保对话数据可回传。</li><li>在会话开始完成设备登记和人设下发，打通个性化主链路。</li><li>推进用户端设备列表、人设与对话历史，形成可连续使用的内测体验。</li></ol></section></div>
<div class="two-column"><section class="panel"><h3>当前风险与待决</h3><ul class="risk"><li><strong>主链路数据未闭环</strong>语音服务仍沿用旧会话标识，导致转写与会话结束数据尚未写入后端。</li><li><strong>运营侧权限边界未完成</strong>管理端资产/诊断接口尚未提供，不能替代用户端认领设备。</li><li><strong>正式发布条件不足</strong>用户端当前为 HTTP 内测入口，域名、HTTPS 与备案尚未完成。</li></ul></section><section class="panel"><h3>项目管理建议</h3><ul class="risk"><li><strong>先验收主链路</strong>以“激活 → 绑定 → 人设 → 语音对话 → 历史可见”作为下一阶段验收口径。</li><li><strong>区分内测与发布</strong>功能开发可并行；对外发布前单独完成域名、HTTPS、安全与回归验证。</li><li><strong>避免跨端越权</strong>用户设备归属只由用户端认领，管理端等待专用资产接口。</li></ul></section></div>
